...
import { colors, project, team, tasks } from '../../shared/data'

const columns = [
  { id: 'todo', label: 'To Do', tasks: tasks.filter(t => t.column === 'todo') },
  { id: 'doing', label: 'In Progress', tasks: tasks.filter(t => t.column === 'doing') },
  { id: 'done', label: 'Done', tasks: tasks.filter(t => t.column === 'done') },
]
